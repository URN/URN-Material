    ...
    <footer id="footer">
        <div class="wrapper">
            ...
            <div>
                ...
                Web Design &amp; Development by <strong>James Turner</strong>, <strong><a href="//harrymt.com" target="_blank">Harry Mumford-Turner</a></strong> and <strong>Iona Hampson</strong>
            </div>
        </div>
    </footer>
</div><!-- end #page-wrap -->
