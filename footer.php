    ...
    <footer id="footer">
        <div class="wrapper">
            ...
            <div>
                ...
                Web Design &amp; Development by <strong><a href="//jamesturner.im" target="_blank">James Turner</a></strong>, <strong><a href="//harrymt.com" target="_blank">Harry Mumford-Turner</a></strong> and <strong>Iona Hampson</strong>
            </div>
        </div>
    </footer>
</div><!-- end #page-wrap -->
